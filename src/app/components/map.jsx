  ...
  return (
    <section className='padding-inline pb-8 ~pt-16/[6.75rem]'>
      <div className='relative mx-auto max-w-6xl'>
        {/* Local coverage information tooltip */}
        ...
        {/* Long-distance coverage information tooltip */}
        ...
        {/* Section heading for geographic coverage */}
        <h2 className='section-heading mb-[2.81rem]'>Geographic Coverage</h2>

        {/* Image displaying the map of geographic coverage */}
